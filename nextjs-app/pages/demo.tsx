...
const SAMPLE_CASES: SampleCase[] = [
  ...
  },
  {
    ...
    text: "A 32-year-old female presents to the emergency department complaining of shortness of breath for several hours. No past medical history, +smoker. Vital signs: RR 32, HR 96, BP 126/80, SpO2 93% on room air, T 98.6˚F. No allergies, current medications include vitamins and birth control pills.",
  ...
  },
  {
    ...
    text: "EMS arrives with an 87-year-old male who fell and hit his head. He is awake, alert, and oriented and remembers the fall. He has a past medical history of atrial fibrillation and is on multiple medications, including warfarin. His vital signs are within normal limits.",
  ...
  },
  {
    ...
    text: "A 60-year-old man requests to see a doctor because his right foot hurts. On exam the great toe and foot skin is red, warm, swollen, and tender to touch. He denies injury. past medical history includes type 2 diabetes, and psoriasis. Vital signs: T 99.4˚F, RR 18, HR 82, BP 146/70, SpO2 99%.",
    expectedDecision: "ESI-3: two or more resources.",
  },
  {
    id: "esi4-uti",
    esi: 4,
    title: "UTI symptoms",
    text: "A 52-year-old female requests to see a doctor for a possible urinary tract infection (UTI). She is complaining of dysuria and frequency. She denies abdominal pain or vaginal discharge. No allergies, takes vitamins, and has no significant past medical history. Vital signs: T 97.4˚F, HR 78, RR 14, BP 142/70.",
  ...
  },
  {
    ...
    text: "“It hurts so much when I urinate,” reports an otherwise healthy 25-year-old. She denies fever, chills, abdominal pain, or vaginal discharge. Vital signs: T 98.2˚F, HR 66, RR 14, BP 114/60.",
    expectedDecision: "ESI-4: one resource.",
  },
  {
    id: "esi5-refill",
